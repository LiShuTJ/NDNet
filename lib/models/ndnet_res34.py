...
class NDNet_Res34(nn.Module):
    def __init__(self, num_classes=1000, f=[64, 128, 256, 512], n=[3, 4, 6, 3]):
        super().__init__()
        
        self.num_classes = num_classes
        self.s = LCGB(3, f[0])
        self.conv3x = self._make_stage(f[0], f[1], n[1], stride=2)
        self.conv4x = self._make_stage(f[1], f[2], n[2], stride=2)
        self.conv5x = self._make_stage(f[2], f[3], n[3], stride=2)
...
if __name__ == '__main__':
    model = NDNet_Res34(19).cuda().eval()
